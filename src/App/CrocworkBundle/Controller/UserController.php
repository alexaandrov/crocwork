...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('AppCrocworkBundle:User')->findAll();
    ...
    {
        $user = new User();
        $form = $this->createForm('App\CrocworkBundle\Form\UserType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('App\CrocworkBundle\Form\UserType', $user);
